...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-gray-200/50 p-1 text-gray-500 backdrop-blur-sm dark:bg-gray-800/50 dark:text-gray-400",
      className
    )}
    {...props}
  />
