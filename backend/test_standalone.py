...
def run_standalone():
    # Force fresh engine & session pool
    engine = create_engine(settings.DATABASE_URL, pool_pre_ping=True)
    SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine)
    db = SessionLocal()

    print("=== INICIANDO TESTE STANDALONE DO FLUXO DE CONCILIAÇÃO ===", flush=True)
    ...
    try:
        ...
        # Verificar Movimentações e Títulos Criados para este workspace
